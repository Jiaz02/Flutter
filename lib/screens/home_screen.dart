import 'package:practicamenu/themes/app_theme.dart';
      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            leading:  const Icon(Icons.question_answer, color: AppTheme.primary,),
            trailing: const Icon(Icons.arrow_forward_ios_outlined, color: AppTheme.primary,),
          ...
          ListTile(
            ...
            leading:  const Icon(Icons.timelapse, color: AppTheme.primary,),
            trailing: const Icon(Icons.arrow_forward_ios_outlined, color: AppTheme.primary,),
            onTap: ()=>Navigator.pushNamed(context, 'temporizador'),
          ),
          const Divider(),
